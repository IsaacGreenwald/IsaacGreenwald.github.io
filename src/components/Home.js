  ...
  return (
    ...
    <div className="home">
      ...
      <p className="home-text">
        I recently graduated from Colorado College with a major in computer science and a minor in statistics. For my senior thesis, I created an analytical dashboard for 
